...
public class PermissionHelpler {
    ...
    public static  void requestPermissions(Activity activity){
        ...
        int permisson_7 = ContextCompat.checkSelfPermission(activity , Manifest.permission.CALL_PHONE);
        ...
        if (permisson_7 != PackageManager.PERMISSION_GRANTED){
...
//        } , 100);
     ...
     * @return
     */
    public static boolean checkHasPermission(Context activity , String permission){
        int permisson = ContextCompat.checkSelfPermission(activity , permission);
        return permisson == PackageManager.PERMISSION_GRANTED;
    }
